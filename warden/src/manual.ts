...
export const MANUAL: ManualSection[] = [
	{
		...
		body: `Every command in this manual is written the same way, and nothing in it is a guess you
...
operator publishes the set and a tenant selects from it.`
	},
	{
		id: 'groups',
		title: 'Groups',
		body: `A group is a named set of settings that tenants and sites start from. You define it
...
nothing to watch.`
	},
	{
		...
		body: `Every secret bastion holds, where it comes from and where it lives. Paths are relative
